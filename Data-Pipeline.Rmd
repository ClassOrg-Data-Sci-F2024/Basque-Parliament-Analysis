...
nrow(merged_data)
```
2842 stems after inner-joining with SEL (stems that did not have matches in the SEL were dropped)
...
## Part 2: Comparing above distribution with non-related 'economy' distribution
